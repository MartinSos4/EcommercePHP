...
<section id="special-price">
    <div class="container">
        <h4 class="front-rubik font-size-20">Precios especiales</h4>
                        ...
                        <div class="text-center">
                            ...
                            <form method="post">
                                ...
                                if (in_array($item['item_id'],$in_cart)){
                                    echo '<button type="submit" disabled name="special_price_submit" class="btn btn-success font-size-12">Añadido</button>';
                                }else {
